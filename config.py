...
STATISTICS_METRICS = ['mean', 'median', 'sigma', 'mad', 
                      ...
                      'scaled_noise_1h', 'scaled_noise_3h', 'scaled_noise_6h',
                      'minerr_noise_1h', 'minerr_noise_3h', 'minerr_noise_6h']
...
STAT_DEFINITIONS = {
    ...
    'scaled_noise_1h': "Scaled transit noise (1h window) via pycheops [ppm]",
    'scaled_noise_3h': "Scaled transit noise (3h window) via pycheops [ppm]",
    'scaled_noise_6h': "Scaled transit noise (6h window) via pycheops [ppm]",
    'minerr_noise_1h': "Minimum error transit noise (1h window) via pycheops [ppm]",
    'minerr_noise_3h': "Minimum error transit noise (3h window) via pycheops [ppm]",
    'minerr_noise_6h': "Minimum error transit noise (6h window) via pycheops [ppm]"
}
...
DATA_SOURCES = {
    'DRP_lightcurve': {
        ...
        'pattern': '**/*R{radius}_V*.fits',
        'exclude_pattern': 'R{radius}_Fixed',
        'default_radius': 25,
        'radius_range': (15, 40),
        'extension': 1,
